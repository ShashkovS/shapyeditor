...
var initSqlJs = function (moduleConfig) {
    ...
    initSqlJsPromise = new Promise((resolveModule, reject) => {
        ...
        var va = function () {
            ...
            var d = function () {
                ...
                a.prototype.get = function (a) {
                    ...
                    var e = [];
                    a = b = 0;
                    for (d = ib(this.fb); 0 <= d ? b < d : b > d; a = 0 <= d ? ++b : --b) switch (Yb(this.fb, a)) {
                        case c.fc:
                        case c.FLOAT:
                            e.push(this.sc(a));
                            break;
                ...
                a.prototype.getColumnNames = function () {
                    ...
                    var c = [];
                    var d = a = 0;
                    for (b = ib(this.fb); 0 <= b ? a < b : a > b; d = 0 <= b ? ++a : --a) c.push(Zb(this.fb, d));
                    return c
                };
                ...
                a.prototype.Qb = function (a, b) {
                    ...
                    switch (typeof a) {
                        ...
                        case "boolean":
                            ...
                            break;
                        case "object":
                            if (null === a) this.nc(b); else if (null != a.length) this.kc(a, b); else throw"Wrong API use : tried to bind a value of an unknown type (" + a + ")."
                    }
                };
            ...
            var e = function () {
                function a(a) {
                    ...
                    if (null != a) {
                        var c = this.filename, d = c ? n("/", c) : "/";
                        c = ia(!0, !0);
                        d = ja(d, (void 0 !== c ? c : 438) & 4095 | 32768, 0);
                        if (a) {
                            if ("string" === typeof a) {
                                for (var e = Array(a.length), k = 0, m = a.length; k < m; ++k) e[k] = a.charCodeAt(k);
                                a = e
                            }
                            ka(d, c | 146);
                            e = p(d, "w");
                ...
                a.prototype.run = function (a, c) {
                    ...
                    c ? (a = this.prepare(a, c), a.step(), a.free()) : this.handleError(m(this.db, a, 0, 0, b));
                    return this
                };
                a.prototype.exec = function (a) {
                    ...
                    for (g = []; q(a, "i8") !== da;) {
                        ...
                        if (k !== da) {
                            var m = new d(k, this);
                            for (k = null; m.step();) null === k && (k = {columns: m.getColumnNames(), values: []}, g.push(k)), k.values.push(m.get());
                            m.free()
                        }
                    }
                    qa(c);
                ...
                a.prototype["export"] = function () {
                    ...
                    if ("utf8" !== e.encoding && "binary" !== e.encoding) throw Error('Invalid encoding type "' + e.encoding + '"');
                    c = p(d, e.flags);
                    d = ra(d).size;
                ...
                a.prototype.create_function = function (a, b) {
                    var d = ua(function (a, c, d) {
                                ...
                                switch (!1) {
                                    ...
                                    case 4 !== z:
                                        return function (a) {
                                            ...
                                            var e = oc(a);
                                            a = new Uint8Array(d);
                                            for (b = c = 0; 0 <= d ? c < d : c > d; b = 0 <= d ? ++c : --c) a[b] = l[e + b];
                                            return a
                                        };
                                    default:
                                        return function () {
                        ...
                        if (c = b.apply(null, k)) switch (typeof c) {
                            case "number":
                                return pc(a, c);
                            case "string":
                                return qc(a, c, -1, -1)
            ...
            var z = f.cwrap("sqlite3_prepare_v2", "number", ["number", "string", "number", "number", "number"]);
            var fa = f.cwrap("sqlite3_prepare_v2", "number", ["number", "number", "number", "number", "number"]);
            var ca = f.cwrap("sqlite3_bind_text", "number", ["number", "number", "number", "number", "number"]);
            var Ia = f.cwrap("sqlite3_bind_blob", "number", ["number", "number", "number", "number", "number"]);
            ...
            var sc = f.cwrap("sqlite3_create_function_v2", "number", "number string number number number number number number number".split(" "));
        ...
        if (x) {
        ...
        } else if (xa) "undefined" != typeof read && (f.read = function (a) {
            return read(a)
        }), f.readBinary = function (a) {
            ...
            return a
        }, "undefined" != typeof scriptArgs ? f.arguments = scriptArgs : "undefined" != typeof arguments && (f.arguments = arguments), "function" === typeof quit && (f.quit = function (a) {
            quit(a)
        }); else if (v || w) w ? A = self.location.href : document.currentScript && (A = document.currentScript.src), A = 0 !== A.indexOf("blob:") ? A.substr(0, A.lastIndexOf("/") + 1) : "", f.read = function (a) {
            var b = new XMLHttpRequest;
            b.open("GET", a, !1);
            b.send(null);
            return b.responseText
        }, w && (f.readBinary = function (a) {
            var b = new XMLHttpRequest;
            b.open("GET", a, !1);
        ...
        var Aa = f.print || ("undefined" !== typeof console ? console.log.bind(console) : "undefined" !== typeof print ? print : null),
            C = f.printErr || ("undefined" !== typeof printErr ? printErr : "undefined" !== typeof console && console.warn.bind(console) || Aa);
        ...
        function Ba(a) {
            var b = D[Ca >> 2];
            a = b + a + 15 & -16;
            if (a <= Da()) D[Ca >> 2] = a; else if (!Ea(a)) return 0;
            return b
        }
        ...
        var Ca = 60128, Ya = f.TOTAL_MEMORY || 16777216;
        5242880 > Ya && C("TOTAL_MEMORY should be larger than TOTAL_STACK, was " + Ya + "! (TOTAL_STACK=5242880)");
        f.buffer ? buffer = f.buffer : "object" === typeof WebAssembly && "function" === typeof WebAssembly.Memory ? (La = new WebAssembly.Memory({initial: Ya / 65536}), buffer = La.buffer) : buffer = new ArrayBuffer(Ya);
        Xa();
        D[Ca >> 2] = 5303264;
        ...
        function Za(a) {
            for (; 0 < a.length;) {
                ...
                if ("function" == typeof b) b(); else {
                    var c = b.rc;
                    "number" === typeof c ? void 0 === b.Fb ? f.dynCall_v(c) : f.dynCall_vi(c, b.Fb) : c(void 0 === b.Fb ? null : b.Fb)
                }
            }
        }
        ...
        var Pa = Math.abs, Qa = Math.ceil, H = 0, fb = null, gb = null;
        f.preloadedImages = {};
        f.preloadedAudios = {};
        ...
        function lb() {
            return f.wasmBinary || !v && !w || "function" !== typeof fetch ? new Promise(function (a) {
                a(kb())
        ...
        function mb(a) {
            function b(a) {
                ...
                0 == H && (null !== fb && (clearInterval(fb), fb = null), gb && (a = gb, gb = null, a()))
            }
            ...
            var e = {env: a, global: {NaN: NaN, Infinity: Infinity}, "global.Math": Math, asm2wasm: Fa};
            H++;
            f.monitorRunDependencies && f.monitorRunDependencies(H);
            ...
            f.wasmBinary || "function" !== typeof WebAssembly.instantiateStreaming || hb() || "function" !== typeof fetch ? d(c) : WebAssembly.instantiateStreaming(fetch(I, {credentials: "same-origin"}), e).then(c, function (a) {
        ...
        function ob(a) {
            if (ob.rb) {
                var b = D[a >> 2];
                var c = D[b >> 2]
            } else ob.rb = !0, J.USER = J.LOGNAME = "web_user", J.PATH = "/", J.PWD = "/", J.HOME = "/home/web_user", J.LANG = "C.UTF-8", J._ = f.thisProgram, c = db ? Ta(1024) : Ba(1024), b = db ? Ta(256) : Ba(256), D[b >> 2] = c, D[a >> 2] = b;
            a = [];
            var d = 0, e;
            for (e in J) if ("string" === typeof J[e]) {
                var g = e + "=" + J[e];
                a.push(g);
                d += g.length
            }
        ...
        function rb(a) {
            ...
            (a = qb(a.split("/").filter(function (a) {
                return !!a
            }), !b).join("/")) || b || (a = ".");
            a && c && (a += "/");
            return (b ? "/" : "") + a
        ...
        var zb = {
            ...
            Xb: function (a) {
                if (!a.input.length) {
                    var b = null;
                    if (x) {
                        var c = new Buffer(256), d = 0, e = process.stdin.fd;
                        ...
                        try {
                            ...
                            if (-1 != k.toString().indexOf("EOF")) d = 0; else throw k
                        }
                        g && fs.closeSync(e);
                ...
                null === b || 10 === b ? (Aa(t(a.output, 0)), a.output = []) : 0 != b && a.output.push(b)
            }, flush: function (a) {
                a.output && 0 < a.output.length && (Aa(t(a.output, 0)), a.output = [])
            }
        }, Bb = {
            Ib: function (a, b) {
                null === b || 10 === b ? (C(t(a.output, 0)), a.output = []) : 0 != b && a.output.push(b)
            }, flush: function (a) {
            ...
            mb: null, jb: function () {
                ...
                M.mb || (M.mb = {
                    ...
                    file: {node: {lb: M.ab.lb, hb: M.ab.hb}, stream: {ob: M.cb.ob, read: M.cb.read, write: M.cb.write, Pb: M.cb.Pb, zb: M.cb.zb, Ab: M.cb.Ab}},
                    link: {node: {lb: M.ab.lb, hb: M.ab.hb, readlink: M.ab.readlink}, stream: {}},
                    Sb: {node: {lb: M.ab.lb, hb: M.ab.hb}, stream: Cb}
                });
                c = Db(a, b, c, d);
                N(c.mode) ? (c.ab = M.mb.dir.node, c.cb = M.mb.dir.stream, c.bb = {}) : 32768 === (c.mode & 61440) ? (c.ab = M.mb.file.node, c.cb = M.mb.file.stream, c.gb = 0, c.bb = null) : 40960 === (c.mode & 61440) ? (c.ab = M.mb.link.node, c.cb = M.mb.link.stream) : 8192 === (c.mode & 61440) && (c.ab = M.mb.Sb.node, c.cb = M.mb.Sb.stream);
                ...
                return a.bb ? a.bb.subarray ? a.bb.subarray(0, a.gb) : new Uint8Array(a.bb) : new Uint8Array
            }, Tb: function (a, b) {
                var c = a.bb ? a.bb.length : 0;
                c >= b || (b = Math.max(b, c * (1048576 > c ? 2 : 1.125) | 0), 0 != c && (b = Math.max(b, 256)), c = a.bb, a.bb = new Uint8Array(b), 0 < a.gb && a.bb.set(c.subarray(0, a.gb), 0))
            }, yc: function (a, b) {
                if (a.gb != b) if (0 == b) a.bb = null, a.gb = 0; else {
                    if (!a.bb || a.bb.subarray) {
                        var c = a.bb;
                        a.bb = new Uint8Array(new ArrayBuffer(b));
                        c && a.bb.set(c.subarray(0, Math.min(b, a.gb)))
                    } else if (a.bb || (a.bb = []), a.bb.length > b) a.bb.length = b; else for (; a.bb.length < b;) a.bb.push(0);
                    a.gb = b
                }
            }, ab: {
                lb: function (a) {
                    ...
                    b.gid = 0;
                    b.rdev = a.rdev;
                    N(a.mode) ? b.size = 4096 : 32768 === (a.mode & 61440) ? b.size = a.gb : 40960 === (a.mode & 61440) ? b.size = a.link.length : b.size = 0;
                ...
                read: function (a, b, c, d, e) {
                    ...
                    if (b.subarray && (!a.bb || a.bb.subarray)) {
                        ...
                        if (0 === a.gb && 0 === e) return a.bb = new Uint8Array(b.subarray(c, c + d)), a.gb = d;
                        if (e + d <= a.gb) return a.bb.set(b.subarray(c, c + d), e), d
                    }
                    M.Tb(a, e + d);
                    if (a.bb.subarray && b.subarray) a.bb.set(b.subarray(c, c + d), e); else for (g = 0; g < d; g++) a.bb[e + g] = b[c + g];
                    a.gb = Math.max(a.gb, e + d);
                    return d
                }, ob: function (a, b, c) {
                    1 === c ? b += a.position : 2 === c && 32768 === (a.node.mode & 61440) && (b += a.node.gb);
                    ...
                    if (k & 2 || c.buffer !== b && c.buffer !== b.buffer) {
                        if (0 < e || e + d < a.node.gb) c.subarray ? c = c.subarray(e, e + d) : c = Array.prototype.slice.call(c, e, e + d);
                        a = !0;
                        d = Ta(d);
            ...
            yb: !1, Ac: function () {
                ...
                a.fs && (a = a.fs);
                P.Ub = {1024: a.O_APPEND, 64: a.O_CREAT, 128: a.O_EXCL, 0: a.O_RDONLY, 2: a.O_RDWR, 4096: a.O_SYNC, 512: a.O_TRUNC, 1: a.O_WRONLY}
            }, Rb: function (a) {
        ...
        }, Gb = null, Hb = {}, Q = [], Ib = 1, R = null, Jb = !0, S = {}, K = null, Eb = {};
        ...
        function T(a, b) {
            ...
            for (d = 0; d < a.length; d++) {
                ...
                if (!g || b.qb) for (g = 0; 40960 === (e.mode & 61440);) if (e = Kb(c), c = vb(sb(c), e), e = T(c, {Jb: b.Jb}).node, 40 < g++) throw new K(40)
            }
        ...
        function Lb(a) {
            for (var b; ;) {
                if (a === a.parent) return a = a.jb.Yb, b ? "/" !== a[a.length - 1] ? a + "/" + b : a + b : a;
                b = b ? a.name + "/" + b : a.name;
                a = a.parent
            }
        }
        ...
        function Ob(a) {
            var b = Mb(a.parent.id, a.name);
            if (R[b] === a) R[b] = a.tb; else for (b = R[b]; b;) {
                if (b.tb === a) {
                    b.tb = a.tb;
                    break
                }
        ...
        function Db(a, b, c, d) {
            Qb || (Qb = function (a, b, c, d) {
                ...
                this.cb = {};
                this.rdev = d
            }, Qb.prototype = {}, Object.defineProperties(Qb.prototype, {
                read: {
                    get: function () {
        ...
        function wc(a, b) {
            xc || (xc = function () {
            }, xc.prototype = {}, Object.defineProperties(xc.prototype, {
                object: {
                    get: function () {
                        return this.node
                    }, set: function (a) {
        ...
        function ta(a) {
            var b = T(a, {parent: !0}).node, c = tb(a), d = O(b, c), e = uc(b, c, !1);
            if (e) throw new K(e);
        ...
        function p(a, b, c, d) {
            ...
            if (!e && (c = g ? 40960 === (g.mode & 61440) ? 40 : N(g.mode) && ("r" !== ic(b) || b & 512) ? 21 : Pb(g, ic(b)) : 2)) throw new K(c);
            b & 512 && Dc(g, 0);
            b &= -641;
            d = wc({node: g, path: Lb(g), flags: b, seekable: !0, position: 0, cb: g.cb, Bc: [], error: !1}, d);
            d.cb.open && d.cb.open(d);
            !f.logReadFiles || b & 1 || (Ec || (Ec = {}), a in Ec || (Ec[a] = 1, console.log("FS.trackingDelegate error on read file: " + a)));
            try {
        ...
        function sa(a, b, c, d, e) {
            ...
            if (!g) e = a.position; else if (!a.seekable) throw new K(29);
        ...
        function la(a, b, c, d, e, g) {
            ...
            if (!k) e = a.position; else if (!a.seekable) throw new K(29);
        ...
        function Gc() {
            ...
            }, K.prototype = Error(), K.prototype.constructor = K, [2].forEach(function (a) {
                Eb[a] = new K(a);
        ...
        function Ea(a) {
            ...
            for (var b = Math.max(Da(), 16777216); b < a;) 536870912 >= b ? b = Wa(2 * b) : b = Math.min(Wa((3 * b + 2147483648) / 4), 2147418112);
            a = Wa(b);
        ...
        function Nc() {
            ...
            if (!Oc) {
                ...
                d = ea(ba(d));
                e = ea(ba(e));
                c.getTimezoneOffset() < b.getTimezoneOffset() ? (D[Rc() >> 2] = d, D[Rc() + 4 >> 2] = e) : (D[Rc() >> 2] = e, D[Rc() + 4 >> 2] = d)
            }
        }
        ...
        function Sc(a) {
            a /= 1E3;
            if ((v || w) && self.performance && self.performance.now) for (var b = self.performance.now(); self.performance.now() - b < a;) ; else for (b = Date.now(); Date.now() - b < a;) ;
            return 0
        }
        ...
        var Vc = f.asm({}, {
            n: B, l: function (a) {
                ...
                B("Assertion failed: " + G(a) + ", at: " + [b ? G(b) : "unknown filename", c, d ? G(d) : "unknown function"])
            }, ga: ob, u: pb, fa: function (a, b) {
                W = b;
                try {
                    var c = Y();
                    ta(c);
                ...
                W = b;
                try {
                    var c = Y(), d = T(c, {parent: !0}).node, e = tb(c), g = O(d, e), k = uc(d, e, !0);
                    if (k) throw new K(k);
                    ...
                    try {
                        ...
                        console.log("FS.trackingDelegate['willDeletePath']('" + c + "') threw an exception: " + m.message)
                    }
                    d.ab.rmdir(d, e);
                    Ob(g);
                    try {
                        ...
                        console.log("FS.trackingDelegate['onDeletePath']('" + c + "') threw an exception: " + m.message)
                    }
                    return 0
                } catch (m) {
                ...
                try {
                    var c = Y(), d = X();
                    var e = X();
                    if (0 >= e) var g = -L.ib; else {
                        var k = Kb(c), m = Math.min(e, oa(k)), y = l[d + m];
                        r(k, F, d, e + 1);
                        l[d + m] = y;
                        g = m
                    }
                ...
                try {
                    ...
                    if (!e) return 0;
                    if (d === e.uc) {
                        var g = Q[e.fd], k = e.flags, m = new Uint8Array(F.subarray(c, c + d));
            ...
            }, L: Da, K: function (a, b, c) {
                F.set(F.subarray(b, b + c), a)
            }, J: Ea, r: Mc, q: function (a) {
                var b = Date.now();
                D[a >> 2] = b / 1E3 | 0;
                D[a + 4 >> 2] = b % 1E3 * 1E3 | 0;
                return 0
        ...
        function Yc() {
            function a() {
                if (!f.calledRun && (f.calledRun = !0, !Ma)) {
                    db || (db = !0, f.noFSInit || Hc || (Hc = !0, Gc(), f.stdin = f.stdin, f.stdout = f.stdout, f.stderr = f.stderr, f.stdin ? Ic("stdin", f.stdin) : Ac("/dev/tty", "/dev/stdin"), f.stdout ? Ic("stdout", null, f.stdout) : Ac("/dev/tty", "/dev/stdout"), f.stderr ? Ic("stderr", null, f.stderr) : Ac("/dev/tty1", "/dev/stderr"), p("/dev/stdin", "r"), p("/dev/stdout", "w"), p("/dev/stderr", "w")), Za(ab));
                    Jb = !1;
                    Za(bb);
            ...
            if (!(0 < H)) {
                if (f.preRun) for ("function" == typeof f.preRun && (f.preRun = [f.preRun]); f.preRun.length;) eb();
                Za($a);
                0 < H || f.calledRun || (f.setStatus ? (f.setStatus("Running..."), setTimeout(function () {
                    setTimeout(function () {
                        f.setStatus("")
                    }, 1);
                    a()
        ...
        return sqlModuleReady.then(function () {
            ...
            switch (data != null ? data.action : void 0) {
                case 'open':
                    ...
                    return postMessage({'id': data.id, 'ready': !0});
                case 'exec':
                    if (db === null) {
                        createDb()
                    }
                    ...
                    return postMessage({'id': data.id, 'results': db.exec(data.sql)});
                case 'each':
                    if (db === null) {
                        createDb()
                    }
                    callback = function (row) {
                        return postMessage({'id': data.id, 'row': row, 'finished': !1})
                    };
                    done = function () {
                        return postMessage({'id': data.id, 'finished': !0})
                    };
                    return db.each(data.sql, data.params, callback, done);
                case 'export':
                    buff = db["export"]();
                    result = {'id': data.id, 'buffer': buff};
                    try {
